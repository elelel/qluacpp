...
auto qlua::api::getOrderByNumber(const char* class_code, unsigned int order_id) const -> std::tuple<table::row::orders, unsigned int> {
...
unsigned int qlua::api::getNumberOf(const char* table_name) const {
